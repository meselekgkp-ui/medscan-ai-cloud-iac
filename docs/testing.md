...
├── test\_generate\_upload\_url.py

└── test\_processing\_helpers.py
...
tests/test\_generate\_upload\_url.py
...
tests/test\_processing\_helpers.py
...
Der relevante Testschritt lautet:
